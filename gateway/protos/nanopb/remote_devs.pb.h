...
#define RemoteDevUniqueId_init_default           {(RadioId)0, 0, {0}}
#define RemoteDevHeader_init_default             {0, RemoteDevUniqueId_init_default}
#define SensorData_init_default                  {{{NULL}, NULL}}
#define RemoteDevData_init_default               {0, {SensorData_init_default}}
#define RemoteDevMessage_init_default            {RemoteDevHeader_init_default, {{NULL}, NULL}}
#define RemoteDevUniqueId_init_zero              {(RadioId)0, 0, {0}}
#define RemoteDevHeader_init_zero                {0, RemoteDevUniqueId_init_zero}
#define SensorData_init_zero                     {{{NULL}, NULL}}
#define RemoteDevData_init_zero                  {0, {SensorData_init_zero}}
#define RemoteDevMessage_init_zero               {RemoteDevHeader_init_zero, {{NULL}, NULL}}

/* Field tags (for use in manual encoding/decoding) */
#define SensorData_data_tag                      1
...
extern const pb_field_t SensorData_fields[2];
extern const pb_field_t RemoteDevData_fields[2];
